...
var CubismModel = /** @class */ (function () {
  ...
  CubismModel.prototype.getDrawableId = function (drawableIndex) {
    ...
    return live2dcubismframework_1.CubismFramework.getIdManager().getId(
      parameterIds[drawableIndex]
    );
  };
  /**
   * Drawableの描画順リストの取得
   ...
   */
  CubismModel.prototype.getDrawableDynamicFlagRenderOrderDidChange = function (
    drawableIndex
  ) {
    var dynamicFlags = this._model.drawables.dynamicFlags;
    ...
    this._parameterMinimumValues = this._model.parameters.minimumValues;
    {
      ...
      for (var i = 0; i < parameterCount; ++i) {
        this._parameterIds.pushBack(
          live2dcubismframework_1.CubismFramework.getIdManager().getId(
            parameterIds[i]
          )
        );
      }
